...
// Пагинация
export const getAdvertisementPageNumber = (state: StateSchema) => state.advertisementsPage?.page;
export const getAdvertisementPageLimit = (state: StateSchema) => state.advertisementsPage?.limit;
export const getAdvertisementPageHasMore = (state: StateSchema) => state.advertisementsPage?.hasMore;
// Сортировка
